...
$(function () {
    ...
    $(".anadido").dblclick(function () {
        ...
        if (id == "texto") {
            ...
            $codigohtml += "<div class=clonado><textarea id=areaclonado cols=30 rows=10>Comentarios </textarea></div>";
        ...
        //
        var $aceptar = " <input type='button' value='Aceptar' id='aceptar'>";
        ...
        $(".clonado").click(function () {
            ...
            $("#aceptar").click(function () {
                ...
                if ($idclonado == "areaclonado") {
                    ...
                    $("#areaclonado").attr("cols", $("#idput").val());
                    $("#areaclonado").attr("rows", $("#idput2").val());
